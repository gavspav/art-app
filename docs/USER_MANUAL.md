...
- If there is no keyboard or MIDI activity for 60 seconds, the app fades to a looping screensaver video. Keyboard or MIDI activity immediately restores the artwork. Debug mode uses a 10-second delay.
