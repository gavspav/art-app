export const palettes = [
  ...
  { name: 'Cyberpunk', colors: ['#ff0090', '#ff4d00', '#00eaff', '#2400ff', '#8fff00'] },
  { name: 'Pastel', colors: ['#ffd1dc', '#faffd1', '#d1ffd6', '#d1e0ff', '#f1d1ff'] },
  { name: 'Forest', colors: ['#004d00', '#33691e', '#558b2f', '#8bc34a', '#aed581'] },
  { name: 'Volcanic', colors: ['#4e342e', '#bf360c', '#d84315', '#ff8f00', '#ffb300'] },
  { name: 'Cosmic', colors: ['#1b0039', '#36007d', '#4b00b5', '#7900f5', '#c800ff'] },
